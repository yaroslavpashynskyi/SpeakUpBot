...
{
    /// <inheritdoc />
    public partial class InReserveStatus : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:payment_status", "pending,in_reserve,to_be_approved,paid_by_card,paid_by_transfer_ticket,to_be_paid_by_cash,cancelled")
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterDatabase()
                ...
                .Annotation("Npgsql:Enum:role", "member,admin")
                .OldAnnotation("Npgsql:Enum:english_level", "pre_intermediate,intermediate,upper_intermediate,advanced")
                .OldAnnotation("Npgsql:Enum:payment_status", "pending,in_reserve,to_be_approved,paid_by_card,paid_by_transfer_ticket,to_be_paid_by_cash,cancelled")
                .OldAnnotation("Npgsql:Enum:role", "member,admin");
        }
    }
}
